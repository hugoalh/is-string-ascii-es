...
await invokeDenoNodeJSTransformer({
	...
	metadata: {
		...
		homepage: "https://codeberg.org/hugoalh/is-string-ascii-es#readme",
		bugs: {
			url: "https://codeberg.org/hugoalh/is-string-ascii-es/issues"
		},
		license: "MIT",
		author: "hugoalh",
		repository: {
			type: "git",
			url: "git+https://codeberg.org/hugoalh/is-string-ascii-es.git"
		},
		private: false,
		publishConfig: {
			access: "public"
